...
const AdminRegulatoryViolationsPage = () => {
    ...
    <MainLayout>
      <div className="p-8">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Regulatory Violations</h1>
            <p className="text-muted-foreground mt-1">Zero-tolerance KPI (target 0)</p>
          </div>
        </div>
...
export default AdminRegulatoryViolationsPage
